...
description: Vercel Web Interface Guidelines — concise MUST/SHOULD/NEVER rules for building accessible, fast, delightful web UIs. Use when writing or reviewing any frontend UI code (components, forms, animation, layout, accessibility, performance).
---
