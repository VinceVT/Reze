...
export const seedReviews: Record<string, Review[]> = {
  day: [
    ...
    },
    {
      ...
      rating: 4,
      date: "2026-03-27",
      body: "Capsules are easy to take and travel well. Docking one star only because I wish the box had a 45-day supply option.",
      verified: true,
    },
  ],
  night: [
  ...
  "reset-duo": [
    ...
    },
    {
      ...
      rating: 5,
      date: "2026-04-25",
      body: "The full system is genuinely better than either half alone — better sleep makes the Day capsules hit different.",
      verified: true,
    },
  ],
};
